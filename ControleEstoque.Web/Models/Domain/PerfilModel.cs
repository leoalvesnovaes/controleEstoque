...
namespace ControleEstoque.Web.Models
{
    public class PerfilModel
    {
        ...
        private static readonly string connectionString = ConfigurationManager.ConnectionStrings["principal"].ConnectionString;
        ...
        //----------------------------------------------------------------------------------------------------------------------------
        //public PerfilModel()     para que serve mesmo? é oq o vini fez?
        //{
