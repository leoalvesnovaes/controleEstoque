...
namespace ControleEstoque.Web.Controllers
{
    ...
    public class CadFornecedorController : Controller
    {
        ...
        //------------------------------------------------------------------------------------------------------------------------
        [HttpPost]
        [ValidateAntiForgeryToken]                     // FAZER FILTRO NA PESQUISA
        public JsonResult FornecedorPagina(int pagina, int tamPag, string filtro, string ordem)
        {
            var lista = Mapper.Map<List<FornecedorViewModel>>(FornecedorModel.RecuperarLista(pagina, tamPag, filtro, ordem: ordem));
